...
async function getBotResponse(userMessage) {
  const API_KEY = "AIzaSyCscz2yUj1z7wjukp4790y-ctpIKnaX4sA";
  const API_URL = `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=${API_KEY}`; // should be change
